...
function CompaniesPage() {
  ...
  const renderCompanyCard = (company) => {
    ...
    return (
      ...
      >
        {/* Bookmark button - Inspired by mobile version */}
        <button 
        ...
        <div className="badges-section">
          ...
          {/* Employee count badge - Prominent position - Support multiple field names */}
        ...
        {/* Capabilities tags - Visible to all users - Support multiple field names */}
        {(() => {
          // Support icnCapabilities or capabilities
        ...
        {/* Sectors tags - Visible to all users - Support multiple field names */}
        {(() => {
          // Support keySectors or sectors
  ...
  // Support multiple verification field names
