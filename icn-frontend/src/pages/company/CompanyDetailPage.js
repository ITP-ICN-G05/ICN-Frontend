              ...
              <div className="content-card company-overview-card">
                ...
                {(currentTier === 'plus' || currentTier === 'premium') && company.abn && (
                  ...
                  <div className="section-title-row">
                    ...
                    <span className="section-title-text">Company ABN</span>
                  </div>
                  <div className="abn-display-container">
                    <p className="abn-display-text" onClick={handleCopyABN}>
                      {formatABN(company.abn)}
                    </p>
                    <button className="abn-copy-btn-inline" onClick={handleCopyABN} title="Copy ABN">
                      {abnCopied ? (
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {abnCopied && <span className="abn-copy-tooltip-inline">ABN Copied!</span>}
                  </div>
              </div>
                )}
